...
module GoLinks
  Link = Data.define(:name, :url, :search_url, :description, :aliases) do
    ...
    # and the rest the search terms — see GoLinks::ApiHelpers.redirect_target.
    # rubocop:disable Lint/ConstantDefinitionInBlock -- attaching a constant to a
    # Data.define class this way is the normal idiom, not an accident of scoping.
